...
Traffic.prototype.runListeners = function(event) {
    if (!this.listeners[event]) return;

    this.listeners[event].forEach(cb => cb());

    // Currently removing the listeners and they'll need to be re-added
...
Traffic.prototype.disconnect = function() {
    ...
    this.runListeners('disconnect');
};

Traffic.prototype.listen = function(event, cb) {
